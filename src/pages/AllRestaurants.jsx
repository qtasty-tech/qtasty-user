...
const AllRestaurants = () => {
  ...
  const [activeCategory, setActiveCategory] = useState({ id: 0, name: "All", slug: "all" });
    ...
    const fetchRestaurants = async () => {
      try {
        ...
        const uniqueCategories = [
          ...
          ...Array.from(new Set(mappedRestaurants.map((r) => r.category)))
            .map((cat, index) => ({
              id: index + 1,
  ...
  const handleCategorySelect = (category) => {
    ...
    applyFilters(searchQuery, priceRange, ratingFilter, category);
  };
  ...
  const handleSearchChange = (e) => {
    ...
    applyFilters(query, priceRange, ratingFilter, activeCategory);
  };
  ...
  const handlePriceChange = (e) => {
    ...
    applyFilters(searchQuery, newPriceRange, ratingFilter, activeCategory);
  };
  ...
  const handleRatingChange = (e) => {
    ...
    applyFilters(searchQuery, priceRange, newRating, activeCategory);
  };

  // Apply all filters
  const applyFilters = (query, price, rating, category) => {
    const filtered = restaurants.filter((restaurant) => {
      ...
      const matchesCategory = category.slug === "all" || restaurant.category.toLowerCase() === category.slug;
  ...
  const clearFilters = () => {
    ...
    setRatingFilter(0);
    setActiveCategory({ id: 0, name: "All", slug: "all" });
    ...
    <div className="bg-gray-50">
      ...
      <section className="bg-primary text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Find Your Favorite Food</h1>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Browse from a wide range of restaurants and find the food that suits your craving.
          </p>
            ...
            <div className="relative">
              ...
              {searchQuery && (
                <button 
                  ...
                  onClick={() => {
                    setSearchQuery("");
                    applyFilters("", priceRange, ratingFilter, activeCategory);
                  }}
                >
                  <X size={20} />
                </button>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            >
              ...
              Filters
              {filtersVisible ? <ChevronUp className="ml-1 h-4 w-4" /> : <ChevronDown className="ml-1 h-4 w-4" />}
            </button>
          </div>
          ...
          {filtersVisible && (
            <div className="mt-4 p-4 bg-white border border-gray-200 rounded-lg animate-fadeIn">
              <div className="flex flex-wrap gap-6">
                ...
                {/* Clear Filters */}
                {(searchQuery || priceRange[0] > 0 || priceRange[1] < 1000 || ratingFilter > 0 || activeCategory.slug !== "all") && (
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800">
              {activeCategory.slug !== "all" ? `${activeCategory.name} Restaurants` : "All Restaurants"}
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h2 className="text-3xl font-bold mb-4">Get the BiteOnWheels App</h2>
