...
const restaurants = [
  ...
  },
  {
    ...
    tags: ['Chinese', 'Asian'],
    isPromoted: false,
    imageUrl: 'https://images.unsplash.com/photo-1563379926898-05f4575a45d8?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80',
  },
  {
    id: 6,
    name: 'Fresh & Fit',
  ...
  useEffect(() => {
    ...
    if (category === 'all') {
      ...
      const filtered = restaurants.filter(restaurant => 
        restaurant.tags.some(tag => tag.toLowerCase() === category.toLowerCase()) ||
    ...
    <div className="animate-fade-in">
      ...
      <section className="bg-primary text-white py-16">
        <div className="container text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">Order from your favorite restaurants and have your meal delivered right to your doorstep.</p>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-lg mb-6">Download our mobile app and never miss a deal. Order your favorite food on the go!</p>
              <div className="flex space-x-4">
                ...
                <button className="bg-black text-white px-6 py-3 rounded-lg flex items-center">
                  <svg viewBox="0 0 512 512" className="w-6 h-6 mr-2" fill="currentColor">
