      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center space-x-2">
            <span className="text-primary text-2xl font-bold">Bite<span className="text-accent">on</span>Wheels</span>
          </Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pt-4 border-t border-gray-200">
            <div className="flex flex-col space-y-4 pb-3">
              <Link 
                to="/" 
                className="text-supportive hover:text-primary transition-colors"
              ...
              <Link 
                to="/cart" 
                className="text-supportive hover:text-primary transition-colors flex items-center"
                onClick={() => setIsMenuOpen(false)}
              >
                <span>Cart</span>
                {totalItems > 0 && (
